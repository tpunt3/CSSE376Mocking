...
namespace ExpediaTest
{
	...
	public class HotelTest
	{
        ...
        [TestMethod]
        public void TestThatHOtelDoesGetRooomOccupantFromTheDatabase()
        {
            ...
            using (mocks.Ordered())
            {
                Expect.Call(mockDB.getRoomOccupant(Arg<int>.Is.Equal(24))).Return(roomOccupant);
                Expect.Call(mockDB.getRoomOccupant(Arg<int>.Is.Equal(1025))).Return(anotherRoomOccupant);
